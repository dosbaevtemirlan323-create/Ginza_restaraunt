...
urlpatterns = [
    ...
    path('api/operator/all-orders/', views.get_all_orders_data, name='get_all_orders'),
    path('discounts/', views.discount_list, name='discount_list'),
    path('discounts/create/', views.create_discount, name='create_discount'),
    path('discounts/toggle/<int:discount_id>/', views.toggle_discount, name='toggle_discount'),
    path('analytics/', views.analytics_dashboard, name='analytics_dashboard'),
    path('api/order-detail/<int:order_id>/', views.api_order_detail, name='api_order_detail'),
